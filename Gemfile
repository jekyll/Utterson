...
gem "jekyll-seo-tag", git: "https://github.com/jekyll/jekyll-seo-tag.git", branch: "no-cache-drop"
gem "jekyll-github-metadata", git: "https://github.com/jekyll/github-metadata.git", branch: "no-cache-drop"
gem "jekyll-avatar"
